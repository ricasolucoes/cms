...
@if (in_array('images', Config::get('siravel.active-core-features', Cms::defaultFeatures())))
...
@if (in_array('files', Config::get('siravel.active-core-features', Cms::defaultFeatures())))
...
@if (in_array('menus', Config::get('siravel.active-core-features', Cms::defaultFeatures())))
...
@if (in_array('promotions', Config::get('siravel.active-core-features', Cms::defaultFeatures())))
...
@if (in_array('widgets', Config::get('siravel.active-core-features', Cms::defaultFeatures())))
...
@if (in_array('blog', Config::get('siravel.active-core-features', Cms::defaultFeatures())))
...
@if (in_array('pages', Config::get('siravel.active-core-features', Cms::defaultFeatures())))
...
@if (in_array('faqs', Config::get('siravel.active-core-features', Cms::defaultFeatures())))
...
@if (in_array('events', Config::get('siravel.active-core-features', Cms::defaultFeatures())))
