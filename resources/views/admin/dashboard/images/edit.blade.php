...
@section('content')
    ...
    <div class="col-md-12 mt-2">
        @include('cms::admin.features.midia.images.breadcrumbs', ['location' => ['edit']])
    </div>
...
@endforeach
                ...
                @if (!is_null($images->entity_id))
                    ...
                    <a href="{{ url('admin/'.$images->entity_type.'s/'.$images->entity_id.'/edit') }}">{{ ucfirst($images->entity_type) }}</a>
                @endif
            </div>
        </div>
