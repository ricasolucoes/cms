    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-6 mt-2">
                @include('cms::admin.components.widgets.breadcrumbs', ['location' => ['edit']])
            </div>
            <div class="col-md-6">
        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <ul class="nav nav-tabs">
                    @include('layouts.tabs', [ 'module' => 'widgets', 'item' => $widget ])
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-12">
                {!! Form::model($widget, ['route' => ['admin.widgets.update', $widget->id], 'method' => 'patch', 'class' => 'edit']) !!}
                    ...
                    <div class="form-group text-right">
                        <a href="{!! cms()->url('widgets') !!}" class="btn btn-secondary float-left">{{ __('pedreiro::generic.cancel') }}</a>
