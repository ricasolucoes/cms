...
@section('content')
    ...
    @include('pedreiro::layouts.module-header', [ 'module' => 'widgets' ])

    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12">
                @if ($widgets->count() === 0)
                    @include('pedreiro::layouts.module-search', [ 'module' => 'widgets' ])
                @else
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @foreach($widgets as $widget)
                                <tr>
                                    <td>
                                        <a href="{!! route('admin.widgets.edit', [$widget->id]) !!}">{!! $widget->name !!}</a>
                                    </td>
                                    <td>{!! $widget->slug !!}</td>
                                    <td class="text-right">
                                        <div class="btn-toolbar justify-content-between">
                                            <a class="btn btn-sm btn-outline-primary mr-2" href="{!! route('admin.widgets.edit', [$widget->id]) !!}"><i class="fa fa-edit"></i> Edit</a>
