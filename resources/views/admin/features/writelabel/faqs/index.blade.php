...
@section('content')
    ...
    @include('pedreiro::layouts.module-header', [ 'module' => 'faqs' ])

    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12">
                @if ($faqs->count() === 0)
                    @include('pedreiro::layouts.module-search', [ 'module' => 'Faqs' ])
                @else
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="btn-toolbar justify-content-between">
                                            <a class="btn btn-sm btn-outline-primary mr-2" href="{!! route('admin.faqs.edit', [$faq->id]) !!}"><i class="fa fa-pencil"></i> Edit</a>
                                            <form method="post" action="{!! url('admin/'.'faqs/'.$faq->id) !!}">
                                                {!! csrf_field() !!}
                                                {!! method_field('DELETE') !!}
