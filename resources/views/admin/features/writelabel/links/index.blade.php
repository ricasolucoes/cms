            ...
            @foreach($links as $link)
                <tr data-id="{{ $link->id }}">
                    <td>
                        ...
                        <a href="{!! route('admin.links.edit', [$link->id]) !!}">{!! $link->name !!}</a>
                    </td>
                    @if ($link->external)
                    ...
                    <td>
                        <div class="btn-toolbar justify-content-between">
                            <a class="btn btn-sm btn-outline-primary mr-2" href="{!! route('admin.links.edit', [$link->id]) !!}"><i class="fa fa-edit"></i> Edit</a>
