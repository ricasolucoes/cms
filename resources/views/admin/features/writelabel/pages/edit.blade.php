    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-6 mt-2">
                @include('cms::admin.features.writelabel.pages.breadcrumbs', ['location' => ['edit']])
            </div>
            <div class="col-md-6">
        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <ul class="nav nav-tabs">
                    @include('layouts.tabs', [ 'module' => 'pages', 'item' => $page ])
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            <div class="@if (config('cms.live-preview', false)) col-md-6 @else col-md-12 @endif">
                {!! Form::model($page, ['route' => ['admin.pages.update', $page->id], 'method' => 'patch', 'class' => 'edit', 'files' => true]) !!}
                    ...
                    @include('cms::admin.features.blocks', ['item' => $page->asObject()])
