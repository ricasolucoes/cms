...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="tab-general">
        <div class="form-group  {{ $errors->has('language_code') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {!! Form::select('language_code', $languages, @isset($article)? $article->language_code : 'default', array('class' => 'form-control')) !!}
        ...
        <div class="form-group  {{ $errors->has('article_category_id') ? 'has-error' : '' }}">
            {!! Form::label('language_code', trans("admin/article.category"), array('class' => 'control-label')) !!}
            <div class="controls">
