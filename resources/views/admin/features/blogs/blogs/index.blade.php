...
@section('content')
    ...
    @include('pedreiro::layouts.module-header', [ 'module' => 'blog' ])

    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12">
                @if ($blogs->count() === 0)
                    @include('pedreiro::layouts.module-search', [ 'module' => 'blogs' ])
                @else
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="btn-toolbar justify-content-between">
                                            <a class="btn btn-sm btn-outline-primary mr-2" href="{!! route('admin.blog.edit', [$blog->id]) !!}"><i class="fa fa-edit"></i> Edit</a>
