...
@section('content')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">{!! trans('features.close') !!}</button>
    ...
    <div class="row">
        <a class="btn btn-primary pull-right" href="{!! route('admin.blog.create') !!}">{!! trans('features.addNew') !!}</a>
        <div class="raw-m-hide raw-m-hide pull-right">
            {!! Form::open(['url' => 'admin/blog/search']) !!}
            ...
            <table class="table table-striped">
                ...
                @foreach($blogs as $blog)
                    <tr>
                        ...
                        <td class="text-right">
                            <form method="post" action="{!! url('admin/blog/'.$blog->id) !!}">
                                {!! csrf_field() !!}
                                {!! method_field('DELETE') !!}
                                <button class="delete-btn btn btn-xs btn-danger pull-right" type="submit"><i class="fa fa-trash"></i> {!! trans('features.delete') !!}</button>
                            </form>
                            <a class="btn btn-xs btn-default pull-right raw-margin-right-8" href="{!! route('admin.blog.edit', [$blog->id]) !!}"><i class="fa fa-pencil"></i> {!! trans('features.edit') !!}</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
