...
@include('pedreiro::layouts.module-header', [ 'module' => 'events' ])

<div class="col-md-12">
    <div class="row">
        <div class="col-md-12">
            @if ($events->count() === 0)
                @include('pedreiro::layouts.module-search', [ 'module' => 'events' ])
            @else
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="btn-toolbar justify-content-between">
                                        <a class="btn btn-sm btn-outline-primary mr-2" href="{!! route('admin.events.edit', [$event->id]) !!}"><i class="fa fa-edit"></i> Edit</a>
